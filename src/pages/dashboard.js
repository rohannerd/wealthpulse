    ...
    <div className="flex flex-wrap items-center justify-end gap-2 sm:gap-4">
      {!isPastMonth() && (
        <button
          ...
          className="flex items-center px-3 sm:px-4 py-2 bg-blue-50 text-blue-600 text-sm sm:text-base rounded-lg hover:bg-blue-100 transition-colors"
        >
          <Target className="mr-1 sm:mr-2 h-4 w-4" />
          <span>Set Goal</span>
        </button>
      )}
      {!isPastMonth() && (
        <button
          ...
          className="flex items-center px-3 sm:px-4 py-2 bg-blue-600 text-white text-sm sm:text-base rounded-lg hover:bg-blue-700 transition-colors"
        >
      ...
      <button
        ...
        className="flex items-center px-3 sm:px-4 py-2 bg-red-600 text-white text-sm sm:text-base rounded-lg hover:bg-red-700 transition-colors"
      >
...
<div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 gap-4">
  ...
  <div className="flex items-center self-center sm:self-auto order-1 sm:order-2 bg-white p-2 rounded-lg shadow-sm">
    <button
...
{userData.goal && isCurrentMonth() && (
  <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm mb-6">
    <div className="flex justify-between items-center mb-2">
      <h2 className="text-base sm:text-lg font-semibold text-gray-800">Goal Progress</h2>
    ...
    <div className="flex justify-between mt-2">
      <span className="text-xs sm:text-sm text-gray-500">Current: {formatCurrency(totalNetWorth)}</span>
      <span className="text-xs sm:text-sm text-gray-500">Goal: {formatCurrency(userData.goal)}</span>
    </div>
  </div>
)}
  ...
  <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm">
    <div className="flex items-center justify-between">
      <div>
        ...
        <h3 className="text-xl sm:text-2xl font-bold text-gray-800">{formatCurrency(totalNetWorth)}</h3>
      </div>
  ...
  <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm">
    <div className="flex items-center justify-between">
      <div>
        ...
        <h3 className="text-xl sm:text-2xl font-bold text-gray-800">{formatCurrency(liquidAssets)}</h3>
  ...
  <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm">
    <div className="flex items-center justify-between">
      <div>
        ...
        <h3 className="text-xl sm:text-2xl font-bold text-gray-800">{formatCurrency(investmentAssets)}</h3>
  ...
  <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm">
    <div className="flex items-center justify-between">
      <div>
        ...
        <h3 className="text-xl sm:text-2xl font-bold text-gray-800">{formatCurrency(physicalAssets)}</h3>
    ...
    <table className="w-full text-left">
      <thead>
        <tr className="border-b">
          <th className="p-2 sm:p-3 text-gray-600 font-medium">Category</th>
          <th className="p-2 sm:p-3 text-gray-600 font-medium">Asset Type</th>
          <th className="p-2 sm:p-3 text-gray-600 font-medium">Value</th>
          <th className="p-2 sm:p-3 text-gray-600 font-medium">% of Total</th>
        </tr>
      </thead>
      <tbody>
        {Object.entries(assetCategories).map(([category, assets]) => (
          Object.entries(assets).map(([assetName, value], index) => (
            ...
            >
              ...
              <td className="p-2 sm:p-3 text-sm sm:text-base">{assetName}</td>
              <td className="p-2 sm:p-3 font-medium text-sm sm:text-base">{formatCurrency(value)}</td>
              <td className="p-2 sm:p-3">
                {totalNetWorth > 0 ? (
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-600 whitespace-nowrap text-sm sm:text-base">
...
{showAddDataModal && (
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-start sm:items-center justify-center z-50 p-2 sm:p-4 overflow-y-auto">
    <div className="bg-white rounded-xl p-3 sm:p-6 w-full max-w-lg my-4 sm:my-0 max-h-[90vh] overflow-y-auto">
      <AddDataForm
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="flex items-center justify-between mb-3 sm:mb-6">
        <h2 className="text-lg sm:text-xl font-bold text-gray-800">Update Asset Values</h2>
        <button
          type="button"
          onClick={onCancel}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-6">
        <div className="space-y-3 mb-3 sm:mb-0">
          <h3 className="text-base sm:text-lg font-medium text-gray-700">Liquid Assets</h3>
          <div>
            <label className="block text-sm sm:text-base text-gray-700 mb-1">Savings Account</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-4 py-2 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
          </div>
          <div>
            <label className="block text-sm sm:text-base text-gray-700 mb-1">Fixed Deposits</label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">₹</span>
              <input
                type="number"
        ...
        <div className="space-y-3 mb-3 sm:mb-0">
          <h3 className="text-base sm:text-lg font-medium text-gray-700">Investments</h3>
          <div>
            <label className="block text-sm sm:text-base text-gray-700 mb-1">Stocks</label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">₹</span>
              <input
                type="number"
          ...
          <div>
            <label className="block text-sm sm:text-base text-gray-700 mb-1">Mutual Funds</label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">₹</span>
              <input
                type="number"
        ...
        <div className="space-y-3 mb-3 sm:mb-0">
          <h3 className="text-base sm:text-lg font-medium text-gray-700">More Investments</h3>
          <div className="grid grid-cols-2 gap-2 sm:gap-4">
            <div>
              <label className="block text-sm sm:text-base text-gray-700 mb-1">NPS</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">₹</span>
                <input
                  type="number"
                  ...
                  onChange={handleChange}
                  className="w-full pl-8 pr-2 py-2 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
            </div>
            <div>
              <label className="block text-sm sm:text-base text-gray-700 mb-1">PPF</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">₹</span>
                <input
                  type="number"
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-4">
            <div>
              <label className="block text-sm sm:text-base text-gray-700 mb-1">EPFO</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">₹</span>
                <input
                  type="number"
            ...
            <div>
              <label className="block text-sm sm:text-base text-gray-700 mb-1">Crypto</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">₹</span>
                <input
                  type="number"
        ...
        <div className="space-y-3 mb-3 sm:mb-0">
          <h3 className="text-base sm:text-lg font-medium text-gray-700">Physical Assets</h3>
          <div>
            <label className="block text-sm sm:text-base text-gray-700 mb-1">Gold</label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">₹</span>
              <input
                type="number"
          ...
          <div>
            <label className="block text-sm sm:text-base text-gray-700 mb-1">Real Estate</label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">₹</span>
              <input
                type="number"
      ...
      <div className="flex justify-end space-x-3 mt-4 sm:mt-6">
        <button
          type="button"
          onClick={onCancel}
          className="px-3 sm:px-4 py-2 border border-gray-300 rounded-lg text-sm sm:text-base text-gray-700 hover:bg-gray-50"
        >
          Cancel
        </button>
        <button
          type="submit"
          className="px-3 sm:px-4 py-2 bg-blue-600 text-white text-sm sm:text-base rounded-lg hover:bg-blue-700"
        >
          Save Changes
        </button>
      </div>
...
const SetGoalForm = ({ initialGoal, onSubmit, onCancel }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="flex items-center justify-between mb-3 sm:mb-6">
        <h2 className="text-lg sm:text-xl font-bold text-gray-800">Set Financial Goal</h2>
        <button
          type="button"
          onClick={onCancel}
          className="text-gray-500 hover:text-gray-700 p-2"
      ...
      <div className="mb-4 sm:mb-6">
        <label className="block text-sm sm:text-base text-gray-700 mb-2">Target Net Worth</label>
        <div className="relative">
          <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">₹</span>
          <input
            type="text"
        ...
        <p className="text-xs sm:text-sm text-gray-500 mt-2">Set a realistic financial goal that you want to achieve</p>
      </div>
